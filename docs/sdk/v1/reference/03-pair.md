...
```typescript
import { ChainId, Token, TokenAmount, Pair } from '@pegasys-fi/v3-sdk'
...
Computes the pair address for the passed [Tokens](token). See [Pair Addresses](../../../contracts/v1/guides/smart-contract-integration/getting-pair-addresses).
...
A Token representing the liquidity token for the pair. See [Pair (ERC-20)](../../../contracts/v1/reference/smart-contracts/pair-erc-20).
...
See [Token0](../../../contracts/v1/reference/smart-contracts/pair#token0).
...
See [Token1](../../../contracts/v1/reference/smart-contracts/pair#token1).
