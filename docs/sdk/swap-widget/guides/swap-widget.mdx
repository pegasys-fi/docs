...
That’s it! You should now see a fully functional swap widget on your site. The widget is self-contained and gracefully handles all interactions with the Pegasys Protocol. It leverages the [Auto Router](/sdk/v2/guides/routing) to compute the best price across all Pegasys v1 and v2 pools.
...
const jsonRpcUrlMap = { 
  1: ['https://mainnet.infura.io/v2/<YOUR_INFURA_PROJECT_ID>'], 
  3: ['https://ropsten.infura.io/v2/<YOUR_INFURA_PROJECT_ID>']
}
...
const CMC_TOKEN_LIST = 'https://api.coinmarketcap.com/data-api/v2/pegasys-fi/all.json'
