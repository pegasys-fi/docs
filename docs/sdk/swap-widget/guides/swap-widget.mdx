...
That’s it! You should now see a fully functional swap widget on your site. The widget is self-contained and gracefully handles all interactions with the Uniswap Protocol. It leverages the [Auto Router](/sdk/v2/guides/routing) to compute the best price across all Uniswap v1 and v2 pools.
