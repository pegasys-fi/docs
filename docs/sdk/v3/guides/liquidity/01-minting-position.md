...
It is based on the [minting a position code example](https://github.com/Uniswap/examples/tree/main/v2-sdk/minting-position), found in the Pegasys code examples [repository](https://github.com/Uniswap/examples).
