...
Uniswap v2 has a protocol fee that can be turned on by UNI governance. Compared to v1, UNI governance has more flexibility in choosing the fraction of swap fees that go to the protocol. For details regarding the protocol fee, see the [whitepaper](https://uniswap.org/whitepaper-v2.pdf).
