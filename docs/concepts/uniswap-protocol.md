...
There are currently three versions of the Uniswap protocol. V1 is open source and licensed under GPL. V2 is open source with slight modifications, which are viewable [here](https://github.com/Pegasys-fi/v2-core/blob/main/LICENSE). Each version of Uniswap, once deployed, will function in perpetuity, with 100% uptime, provided the continued existence of the Ethereum blockchain.
