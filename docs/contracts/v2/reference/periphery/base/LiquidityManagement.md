Internal functions for safely managing liquidity in Pegasys V2
...
```solidity
  ...
  ) internal returns (uint128 liquidity, uint256 amount0, uint256 amount1, contract IPegasysV2Pool pool)
```
