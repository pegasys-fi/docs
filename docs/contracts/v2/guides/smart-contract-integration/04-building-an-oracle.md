...
[here](https://github.com/Pegasys-fi/v1-periphery/blob/master/contracts/examples/ExampleOracleSimple.sol).
...
[here](https://github.com/Pegasys-fi/v1-periphery/blob/master/contracts/examples/ExampleSlidingWindowOracle.sol).
...
[ExampleSlidingWindowOracle](https://github.com/Pegasys-fi/v1-periphery/blob/master/contracts/examples/ExampleSlidingWindowOracle.sol)
